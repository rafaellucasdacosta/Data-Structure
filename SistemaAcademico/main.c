...
int main()
{
    ...
    do
    {
        ...
        case 1: // CASO OPÇÃO SEJA 1 IRÁ CADASTRAR O ALUNO
            ...
            controlePorLista = insere(&lista, al);//CHAMA A FUNÇÃO DE INSERÇÃO
        ...
        case 2: // CASO A OPÇÃO SEJA 2 IRÁ BUSCAR O ALUNO POR RA
            ...
            printf("  \nRA: ");
            scanf("%i",&cod);
            retornoBusca = procuraRa(arvoreRA, cod);//CHAMA A FUNÇÃO QUE FAZ A BUSCA POR RA
        ...
        case 3: // CASO A OPÇÃO SEJA 3 IRÁ BUSCAR O ALUNO POR NOME
            ...
            printf("  \nNOME: ");
            scanf("%s", &nome);
            retornoBusca = procuraNome(arvoreNome, nome);//CHAMA A FUNÇÃO QUE IRÁ PROCURAR POR NOME
            if(retornoBusca != NULL)
            {
                printf("  ---------------------------------------\n");
                printf(" |            ALUNO ENCONTRADO           |\n");
        ...
        case 5: // CASO A OPÇÃO SEJA 5 IRÁ EXCLUIR PELO RA
            ...
            printf("  \nRA: ");
            scanf("%i",&cod);
            retornoBusca = procuraRa(arvoreRA, cod);//CHAMA A FUNÇÃO QUE PROCURA O RA
            if(retornoBusca != NULL)
            {
                arvoreRA = removeRa(arvoreRA, retornoBusca->aluno->RA);//CHAMA A FUNÇÃO QUE RETORNA O RA DA ARVORE
                arvoreNome = removeNome(arvoreNome, retornoBusca->aluno->nome);// CHAMA FUNÇAO QUE RETORNA O NOME DA ARVORE
        ...
        case 6: // CASO A OPÇÃO SEJA 6 IRÁ EXCLUIR O ALUNO PELO NOME
            ...
            printf("\nNOME: ");
            scanf("%s", &nome);
            retornoBusca = procuraNome(arvoreNome, nome);//CHAMA A FUNÇÃO QUE FAZ A BUSCA DO ALUNO PELO NOME
            if(retornoBusca != NULL)
            {
                arvoreRA = removeRa(arvoreRA, retornoBusca->aluno->RA);//CHAMA A FUNÇÃO QUE RETORNA O RA DA ARVORE
                arvoreNome = removeNome(arvoreNome, retornoBusca->aluno->nome);// CHAMA A FUNÇÃO QUE RETORNA O NOME DA ÁRVORE
        ...
        case 7: // CASO A OPÇÃO SEJA 7 IRÁ ENCERRAR O SISTEMA E LIBERAR OS ESPAÇOS DA MEMÓRIA
            reinicializaSistema(&arvoreRA, &arvoreNome, &lista);//CHAMA A FUNÇÃO PARA LIBERAR ESPAÇO DA MEMÓRIA
            break;
        default:
            system("cls");
